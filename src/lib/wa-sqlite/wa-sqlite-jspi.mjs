    ...
    return (
        function (moduleArg = {}) {
            ...
            function findWasmBinary() {
                if (Module["locateFile"]) {
                    var f = "wa-sqlite-jspi.wasm";
                    if (!isDataURI(f)) {
                        return locateFile(f)
                    }
                    return f
                }
                return new URL("wa-sqlite-jspi.wasm", import.meta.url).href
            }
            ...
            var Asyncify = {
                instrumentWasmImports(imports) {
                    ...
                    var exportPattern = /^(sqlite3_close|sqlite3_finalize|sqlite3_open_v2|sqlite3_prepare|sqlite3_prepare16|sqlite3_prepare_v2|sqlite3_prepare16_v2|sqlite3_prepare_v3|sqlite3_prepare16_v3|sqlite3_reset|sqlite3_step|main|__main_argc_argv)$/;
